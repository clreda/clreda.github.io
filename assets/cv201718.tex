...
\extrainfo{Last modified on 09/14/18\\}
%\extrainfo{}
...
\cvitem{Python 3, Scala, Matlab}{Used for several projects, more especially in bioinformatics.}
\cvitem{LaTeX, TeX, Beamer}{Widely-used for reports and defences.}
\cvitem{Other self-taught languages/frameworks:}{Django, Jekyll, Shiny, HTML/CSS, PHP, SQL, Bash, C/C++, Intel x86 Assembly, Haskell.}
